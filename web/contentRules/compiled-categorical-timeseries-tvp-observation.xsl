...
<!--SCHEMA SETUP-->
<xsl:template match="/"><svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="OGC WaterML2.0 categorical timeseries (tvp) observation" schemaVersion=""><xsl:comment><xsl:value-of select="$archiveDirParameter"/>   
		 <xsl:value-of select="$archiveNameParameter"/>  
		 <xsl:value-of select="$fileNameParameter"/>  
		 <xsl:value-of select="$fileDirParameter"/></xsl:comment><svrl:text>Verifies that the OM_Observation result type is valid according to the WaterML2 categorical timeseries observation . Tests
...
<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">OGC WaterML2.0 categorical timeseries (tvp) observation</svrl:text>

<!--PATTERN resultTest requirement: /req/xsd-categorical-timeseries-tvp-observation/result -->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Test requirement: /req/xsd-categorical-timeseries-tvp-observation/result </svrl:text>
