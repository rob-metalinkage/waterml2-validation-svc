...
<schema fpi="http://schemas.opengis.net/waterml/2.0/waterObservation.sch" see="http://www.opengeospatial.org/projects/groups/waterml2.0swg"
  ...
  <title>WaterML2.0 observation validation</title>
  ...
  <pattern id="phenomenonTime">
    ...
    <rule context="//om:OM_Observation/om:phenomenonTime">
      <assert test="schema-element(gml:TimePeriod) | @xlink:href">The xml element om:metadata shall contain a subelement of wml2:ObservationMetadata, a
        member of its substitution group or a reference to an external definition of the process using the xlink:href attribute.</assert>
    </rule>
  </pattern>
</schema>
