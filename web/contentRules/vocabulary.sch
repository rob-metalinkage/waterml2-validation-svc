...
<schema fpi="http://schemas.opengis.net/waterml/2.0/xml_rules.sch" 
  ...
  <p>This schematron schema checks the XML encoding requirements of OGC WaterML2.0, as specified
    in the requirements class: http://www.opengis.net/spec/waterml/2.0/req/vocabulary-rules</p>
  ...
  <pattern id="InterpolationType">
    <title>Test recommendation: http://www.opengis.net/spec/waterml/2.0/req/vocabulary-rules/interpolationType</title>
  ...
  <pattern id="processType">
    <title>Test recommendation: http://www.opengis.net/spec/waterml/2.0/req/vocabulary-rules/processType</title>
  ...
  <pattern id="quality">
    <title>Test recommendation: http://www.opengis.net/spec/waterml/2.0/req/vocabulary-rules/quality</title>
  ...
  <!-- medium should probably be moved to a loose file -->
  <pattern id="medium">
    <title>Test recommendation: http://www.opengis.net/spec/waterml/2.0/req/vocabulary-rules/medium</title>
