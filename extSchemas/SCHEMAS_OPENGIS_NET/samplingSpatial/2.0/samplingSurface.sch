...
<schema
    fpi="http://schemas.opengis.net/samplingSpatial/2.0/samplingSurface.sch"
    ...
    <p>Verifies that all instances of SF_SpatialSamplingFeature have a shape that matches the
        pattern for SamplingSurface</p>
    <ns
        prefix="gml"
