...
<schema
    ...
    <p>This Schematron schema checks that the content model of each observation result is consistent with the type of the observation.</p>
    <ns
        prefix="gml"
    ...
    <pattern
        ...
        <rule
            ...
            <include href="./result-DataRecord.sch"/>
        </rule>
    </pattern>
