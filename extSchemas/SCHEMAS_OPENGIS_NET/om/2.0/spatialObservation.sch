...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern>
        ...
        <sch:rule context="//*[om:phenomenonTime]">
            <sch:assert
    ...
    <sch:pattern>
        ...
        <sch:rule
            context="//*[om:phenomenonTime]/om:parameter/om:NamedValue[om:name/@xlink:href= 'http://www.opengis.net/req/omxml/2.0/data/samplingGeometry']/om:value">
