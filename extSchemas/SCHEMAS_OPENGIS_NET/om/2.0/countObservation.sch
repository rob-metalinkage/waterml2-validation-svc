...
<schema
    fpi="http://schemas.opengis.net/om/2.0/countObservation.sch"
    ...
    <p>Verifies that all instances of OM_Observation have a result that matches the pattern for CountObservations</p>
    <ns
        prefix="om"
    ...
    <pattern
        ...
        <rule
            ...
            <include href="./result-integer.sch"/>
        </rule>
    </pattern>
