...
<schema
    fpi="http://schemas.opengis.net/om/2.0/pointCoverageObservation.sch"
    ...
    <p>Verifies that all instances of OM_Observation have a result that matches the pattern for PointCoverageObservations</p>
    <ns
        prefix="gml"
