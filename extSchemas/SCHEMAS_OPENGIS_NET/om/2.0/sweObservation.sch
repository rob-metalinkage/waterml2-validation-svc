...
<schema fpi="http://schemas.opengis.net/om/2.0/sweObservation.sch"
    ...
    <title>SWE observation validation</title>
    <p>Verifies that all instances of OM_Observation have a result that matches the pattern for SWEObservations</p>
    <ns
        prefix="om"
    ...
    -->
    <xsl:import-schema schema-location="../../sweCommon/2.0/swe.xsd"/>
    
    <pattern
        id="observation-type-swe">
        <rule
            context="//om:OM_Observation">
            <include href="./result-SWE.sch"/>
        </rule>
    </pattern>
