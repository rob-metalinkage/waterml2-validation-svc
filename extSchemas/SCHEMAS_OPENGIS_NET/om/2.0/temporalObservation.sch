...
<schema
    fpi="http://schemas.opengis.net/om/2.0/temporalObservation.sch"
    ...
    <p>Verifies that all instances of OM_Observation have a result that matches the pattern for TemporalObservations</p>
    <ns
        prefix="gml"
