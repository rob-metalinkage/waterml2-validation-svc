...
<schema fpi="http://schemas.opengis.net/samplingSpatial/2.0/samplingPoint.sch"
    ...
    <pattern id="PointTest">
        <rule context="//sams:SF_SpatialSamplingFeature/sams:shape">
            <assert test="schema-element(gml:Point) | @xlink:href">a member of the substitution
                group headed by gml:Point or an xlink must be present as child of
                sams:shape</assert>
        </rule>
    </pattern>
