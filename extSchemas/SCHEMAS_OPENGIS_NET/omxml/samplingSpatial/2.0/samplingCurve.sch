...
<schema fpi="http://schemas.opengis.net/samplingSpatial/2.0/samplingCurve.sch"
    ...
    <pattern id="CurveTest">
        <rule context="//sams:SF_SpatialSamplingFeature/sams:shape">
            <assert test="schema-element(gml:AbstractCurve) | @xlink:href">a member of the
                substitution group headed by gml:AbstractCurve or an xlink must be present as child
