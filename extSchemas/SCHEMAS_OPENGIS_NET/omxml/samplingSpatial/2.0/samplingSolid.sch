...
<schema fpi="http://schemas.opengis.net/samplingSpatial/2.0/samplingSolid.sch"
    ...
    <pattern id="SolidTest">
        <rule context="//sams:SF_SpatialSamplingFeature/sams:shape">
            <assert test="schema-element(gml:AbstractSolid) | @xlink:href">a member of the
                substitution group headed by gml:AbstractSolid or an xlink must be present as child
                of sams:shape</assert>
        </rule>
    </pattern>
